...
*/
#define qh_INFINITE                                                            \
  -10.101                 /* on output, indicates Voronoi center at infinity */
...
-DIMreduceBuild  max dimension for vertex reduction during build (slow in
high-d)

-RATIOnearinside ratio of NEARinside to ONEmerge for retaining inside points for
                 qh_check_maxout.  This is overkill since do not know the
correct value.
...
#define qh_BESTcentrum                                                         \
  20 /* qh_findbestneighbor tests centrum instead of vertices */
#define qh_BESTcentrum2                                                        \
  2 /*   if BESTcentrum2 * hull_dim + BESTcentrum < #vertices */
...
#define qh_DIMreduceBuild                                                      \
  5 /* maximum dimension for reduce vertices during build */
...
#define qh_RATIOnearinside                                                     \
  5 /* ratio of distance for NEARinside to ONEmerge                            \
       this effects whether 'Qc' reports all coplanar points */
#define qh_USEfindbestnew                                                      \
  50 /* use qh_findbestnew if > n merged facets, or merged cone */
...
#define qh_WARNnarrow                                                          \
  -0.9999 /* to warn about qh_MAXnarrow.  In practise                          \
